package com.qkrfowns45.firstproject.aop;
...
public class PerformanceAspect {
    ...
    //특정 어노테이션을 대상 지정
    @Pointcut("@annotation(com.qkrfowns45.firstproject.annotation.RunningTime)")
    private void enableRunningTime(){}

    //기본 패키지의 모든 메소드
    @Pointcut("execution(* com.qkrfowns45.firstproject..*.*(..))")
    private void cut(){}
